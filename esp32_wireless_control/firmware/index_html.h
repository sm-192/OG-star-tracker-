    ...
    <body onload="handleLoad()">
        <div class="content">
            ...
            <div class="card">
                ...
                <h4>%STR_SLEW_HINT%</h4>
                <div class="button-group">
                    <button class="right-separator" type="button" ontouchstart="sendSlewRequest('left')"
                        onmousedown="sendSlewRequest('left')" ontouchend="sendSlewStop()" onmouseup="sendSlewStop()"
                        onmouseleave="sendSlewStop()" ontouchcancel="sendSlewStop()">%STR_SLEW_LEFT%</button>
                    <button class="left-separator" type="button" ontouchstart="sendSlewRequest('right')"
                        onmousedown="sendSlewRequest('right')" ontouchend="sendSlewStop()" onmouseup="sendSlewStop()"
                        onmouseleave="sendSlewStop()" ontouchcancel="sendSlewStop()">%STR_SLEW_RIGHT%</button>
                </div>
            ...
            <div class="card">
                ...
                <div class="grid2">
                    <h3 id='custom-gotora-speed-text' style="display:none; align-items:center;">%STR_CUSTOM_SPEED%:</h3>
                    <input id='custom-gotora-speed' type='number' value='2' min='2' max='400' style="display:none;" />
                    <br>
                </div>
                <div class="grid3x4">
                    <div></div>
                ...
                <div class="button-group">
                    <button class="right-separator" type="button" id='start-gotora-button'
                        onclick="sendGoToRAInformation();" disabled>
                        %STR_START_GOTO_RA%
                    </button>
                    <button class="left-separator" type="button" onclick="sendRequest('/abort-goto-ra');">
                        %STR_STOP_GOTO_RA%
                    </button>
                </div>
            </div>
            <div class="card">
                ...
                <div class="button-group">
                    <button class="right-separator" type="button" id='save-button'
                        onclick="sendCaptureInformation('save');" disabled>%STR_SAVE_PRESET%</button>
                ...
                <div class="grid2" id='exposureDiv'>
                    ...
                    <input type='number' id='exposureTime' placeholder='%STR_EXPOSURE_HINT%'
                        onchange="calculateCaptureTime();">
                </div>
                <div class="grid2">
                    <h3>%STR_NO_EXPOSURES%:</h3>
                    <input type='number' id='exposures' placeholder='%STR_NUM_EXPOSURES_HINT%'
                        onchange="calculateCaptureTime();">
                </div>
                <div class="grid2">
                    <h3>%STR_PRE_DELAY%:</h3>
                    <input type='number' id='preDelay' placeholder='%STR_EXPOSURE_HINT%'
                        onchange="calculateCaptureTime();">
                </div>
                <div class="grid2">
                    <h3>%STR_DELAY%:</h3>
                    <input type='number' id='delay' placeholder='%STR_EXPOSURE_HINT%'
                        onchange="calculateCaptureTime();">
                </div>
                ...
                <div class="grid2" id='ditherFreqDiv'>
                    ...
                    <input type="number" id="ditherFrequency" placeholder='%STR_NUM_EXPOSURES_HINT%'
                        onchange="calculateCaptureTime();">
                </div>
                <div class="grid2" id='ditherFocalLengthDiv'>
                    <h3>%STR_FOCAL_LENGTH%:</h3>
                    <input type="number" id="focalLength" placeholder='%STR_FOCAL_LENGTH_HINT%'
                        onchange="calculateCaptureTime();">
                </div>
                <div class="grid2" id='ditherPixelSizeDiv'>
                    <h3>%STR_PIXEL_SIZE%:</h3>
                    <input type="number" id="pixelSize" placeholder='%STR_PIXEL_SIZE_HINT%' step="0.01"
                        onchange="calculateCaptureTime();">
                </div>
                <div class="button-group">
                    <button class="right-separator" type="button" id='capture-button'
                        onclick="sendCaptureInformation('start');" disabled>%STR_START_CAPTURE%</button>
                    <button class="left-separator" type="button"
